...
const dashboard = () => {
  ...
  //       const docRef = doc(db, "iit-team-users", user.uid);
  ...
  useEffect(() => {
    async function fetchUsers() {
      ...
      setTeamList(users);
      // console.log(users[0]["iit_user_name_26_10_2022_01:19:52"]["Current CO2"])
    }
    fetchUsers();
  }, []);
  ...
  return (
    <div>
      <div class="  flex overflow-hidden bg-[#f9fafb] pt-16 ">
        <aside
          id="sidebar"
          class="    bg-[#64c297] fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75"
          aria-label="Sidebar"
        >
              ...
              <div class=" flex-1 px-3 bg-[#64c297] divide-y space-y-1 ">
                <ul class=" space-y-2 pb-2">
                  <li>
                    <a
                      href="#"
                      class="text-base text-[#e9ecef] font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group text-black"
                    >
                      <svg
                        class="w-6 h-6 text-[#e9ecef] group-hover:text-gray-900 transition duration-75"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                  ...
                  <li>
                    <a
                      href="#"
                      target="_blank"
                      class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group  text-black"
                    >
                      <svg
                        class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                  ...
                  <li>
                    <a
                      href="#"
                      class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 text-black flex items-center p-2 group "
                    >
                      <svg
                        class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                        fill="currentColor"
                ...
                <div class="space-y-2 pt-2">
                  <a
                    href="#"
                    target="_blank"
                    class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 text-black group transition duration-75 flex items-center p-2"
                  >
                    <svg
                      class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                      fill="currentColor"
        ...
        >
          <main>
            {/* hello, {teamList[0]["iit_user_name_26_10_2022_01:19:52"]} */}
            <div class="pt-6 px-4">
                ...
                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                  <div class="flex items-center">
                    <div class="flex-shrink-0">
                      ...
                      <h3 class="text-base font-normal text-gray-500">
                        Total CO2 Emissions Captured Per Year
                      </h3>
                    </div>
                  </div>
                </div>
    ...
    <h1 className="	 text-5xl">Heatmap of your surrounding area</h1>

    {/* <div className="flex">
      <div className="block">
    <img src="/map1.jpeg" className = "justify-center items-center text-center "alt="% graph"  width= "30%" height="30%"/>
    <figcaption>Caption goes here</figcaption>
    <img src="/map2.jpeg" className = "justify-center items-center text-center p-10"alt="% graph"  width= "30%" height="30%"/>
    <img src="/map3.jpeg" className = "justify-center items-center text-center p-10"alt="% graph"  width= "30%" height="30%"/>
    ...
    <img class="rounded-lg shadow-xl hover:shadow-2xl" src="/map1.jpeg"/>
  ...
  <figure class="relative max-w-xs cursor-pointer">
    <img class="rounded-lg shadow-xl hover:shadow-2xl"  src="/map2.jpeg"/>
    <figcaption class="absolute text-lg -mt-16 text-white px-4">
      <div>
        <h1>10km</h1>
      </div>
  ...
  <figure class="relative max-w-xs cursor-pointer">
    <img class="rounded-lg shadow-xl hover:shadow-2xl"  src="/map3.jpeg"/>
    <figcaption class="absolute text-lg -mt-16 text-white px-4">
      <div>
        <h1>5km</h1>
      </div>
