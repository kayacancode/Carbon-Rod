            ...
            <div class=" bg-[#64c297]flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
               <div class=" flex-1 px-3 bg-[#64c297] divide-y space-y-1 ">
                  <ul class=" space-y-2 pb-2">
                     ...
                     <li>
                        <a href="#" class="text-base text-[#e9ecef] font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group text-black">
                     ...
                     <li>
                        <a href="#" target="_blank" class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group  text-black">
                     ...
                     <li>
                        <a href="#" class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 text-black flex items-center p-2 group ">
                        <svg class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="space-y-2 pt-2">
                     ...
                     <a href="#" target="_blank" class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 text-black group transition duration-75 flex items-center p-2">
                        <svg class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
